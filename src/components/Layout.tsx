...
<script>{`
    var __cbSdkHost = "https://sdk.leowu.uk/";
    ...
    !function(a,h,e,v,n,t,s)
      ...
      "https://d1z56u54330myd.cloudfront.net/"+'sdk/capig-events.js');
    cbq('init', "7515854803001328034");
    cbq('loadConfig', "7515854803001328034");
    cbq('track', 'PageView');`}
    </script>
